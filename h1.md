...
Apuna käytin youtube-videota: Metasploitable 2 - Installation on VirtualBox 6.1 - Cyber Security #8 https://www.youtube.com/watch?v=JLMdvpv7aTM

![21](https://github.com/user-attachments/assets/5fb02ce8-25cf-4d49-ba68-90a4790bcbd5)

Annoin koneelle nimen Metasploit, tyypiksi Linux ja versioksi Debian (64-bit). Hed Disk osiossa valitsin "Use an Existing Virtual Hard Disk File" ja valitsin siihen lataamani Metasploitable.vmdk.
...
Apuna käytin tässä youtube-videota: How to make Two Virtual Machines Communicate each other in VirtualBox https://www.youtube.com/watch?v=DzmUOeFdc-w
